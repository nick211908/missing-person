...
const PhoneCamera = () => {
  ...
  const statusStyle = () => {
    if (connectionStatus === 'connected') {
      ...
      return { background: 'rgba(59, 130, 246, 0.1)', color: 'var(--accent-primary)', borderColor: 'rgba(59, 130, 246, 0.2)' };
    } else if (connectionStatus === 'error') {
      return { background: 'rgba(239, 68, 68, 0.1)', color: 'var(--danger)', borderColor: 'rgba(239, 68, 68, 0.2)' };
    }
    return { background: 'rgba(107, 114, 128, 0.1)', color: 'var(--text-secondary)', borderColor: 'rgba(107, 114, 128, 0.2)' };
  };
